...
internal static class DesktopAgentHosting
{
    internal const string AgentInstructions = """
        ...
        If the request explicitly says it is a smoke test or health check, or says not to use tools,
        applications, or a desktop, reply directly without calling any tool.
        Otherwise, start with open_desktop, show its live-view and take-control links, then list_desktop_tools.
